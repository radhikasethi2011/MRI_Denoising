...
if __name__ == "__main__":
    ...
    pretrained_model_path = 'C:/Users/ebjor/DDM2/checkpoint_stage1/latest_gen.pth'
    if os.path.exists(pretrained_model_path):
        logger.info(f"Loading pretrained model for G [{pretrained_model_path}] ...")
        diffusion.load_network(pretrained_model_path)
